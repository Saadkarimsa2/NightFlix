...
const Home: NextPage = () => {
  ...
  useEffect(() => {
    ...
    const messages = [
      ...
      "You are my heart's desire, my greatest joy, loving you is the best part of my life. ❤️😊",
  ...
  const imagesItems = [
    <Image key="1" src={card1} alt='Series First' className="w-full h-full" onClick={() => handleImageClick('Series_first')} />,
    <Image key="2" src={card2} alt='Series Second' className="w-full h-full" onClick={() => handleImageClick('Series_second')} />,
    <Image key="3" src={card3} alt='Series Third' className="w-full h-full" onClick={() => handleImageClick('Series_third')} />,
    <Image key="4" src={card4} alt='Series Fourth' className="w-full h-full" onClick={() => handleImageClick('Series_fourth')} />,
    <Image key="5" src={card5} alt='Series Fifth' className="w-full h-full" onClick={() => handleImageClick('Series_fifth')} />,
    <Image key="6" src={card6} alt='Series Sixth' className="w-full h-full" onClick={() => handleImageClick('Series_sixth')} />,
  ...
  return (
    <div className='h-screen w-screen overflow-y-auto overflow-x-hidden bg-bg text-white'>
      ...
      <main className='flex w-full flex-1 flex-col items-center justify-center px-20 pt-24 text-center'>
        {showVideo && (
          <button
